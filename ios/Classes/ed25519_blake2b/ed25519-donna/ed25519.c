...
void
ED25519_FN(ed25519_sign) (const unsigned char *m, size_t mlen, const unsigned char *randr, const ed25519_secret_key sk, const ed25519_public_key pk, ed25519_signature RS) {
	ed25519_hash_context ctx;
	bignum256modm r, S, a;
	ge25519 ALIGN(16) R;
